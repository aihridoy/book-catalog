...
export default function FavoriteBooks() {
  ...
  const favorites = (favoritesData?.data || []) as IBook[];
      ...
      {isLoading ? (
        ...
        <div className="text-center">
          <div className="bg-white bg-opacity-70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white border-opacity-50 max-w-md mx-auto">
            <HeartFilled className="text-6xl text-red-400 mb-4" />
            <p className="text-gray-600 mb-4">
              No books added to favorites yet.
            </p>
            <Link
              to="/"
          ...
          {favorites.map((book) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="w-16 h-24 bg-gradient-to-br from-amber-500 to-orange-500 rounded-lg flex items-center justify-center flex-shrink-0 shadow-md overflow-hidden relative">
                  {book.image ? (
                    <img
                      src={book.image}
                      alt={book.title}
                  ...
                  <HeartFilled className="absolute -top-1 -right-1 text-red-500 text-lg" />
                </div>
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Popconfirm
                  ...
                  description={
                    <div className="max-w-[250px] sm:max-w-xs">
                      <p className="text-gray-600 mb-2 text-xs sm:text-sm">
                        Are you sure you want to remove this book by{" "}
                        <strong>{book.author}</strong> from your favorites?
                      </p>
                  ...
                  onConfirm={() => handleRemoveFavorite(book._id!)}
                  okText={
                    <span className="text-xs sm:text-sm">Yes, Remove</span>
                  }
                  cancelText={
